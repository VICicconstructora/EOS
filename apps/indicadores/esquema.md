# Contexto de la Base de Datos: ERP Comercial

Esta base de datos contiene modelos semánticos obtenidos de nuestro ERP con información comercial, de trámites y de cartera. 

**REGLA CRÍTICA NÚMERO 1: EL ESQUEMA Y LOS NOMBRES DE TABLAS**
- TODAS las tablas se encuentran obligatoriamente en el esquema `sinco_ic_raw`.
- Los nombres de las tablas SIEMPRE son en minúsculas y sin espacios, típicamente con el prefijo `adi_dtm_`.
- Ejemplos obligatorios: `sinco_ic_raw.adi_dtm_venta`, `sinco_ic_raw.adi_dtm_tramites`, `sinco_ic_raw.adi_dtm_comprador`, `sinco_ic_raw.adi_dtm_proyectos`.
